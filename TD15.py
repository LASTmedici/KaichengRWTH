...
def calculate_3d_points(file1, file2, fx1, fx2, baseline):
    ...
    for idx, row in data1.iterrows():
        ...
        if not match.empty:
            ...
            # 计算视差
            disparity = center_x1 - center_x2#始终保持是左减右
...
def main():
    # caption = 'there is a black drone'
    # directories = [
    #     ('F:/data5/data20240612/test_16mm_markerP4_1LED_demo_0/raw_data_0_pieces', 1786, 1820, 'output_video1.mp4', 'tracking_data1.csv'),
    #     ('F:/data5/data20240612/test_16mm_markerP4_1LED_demo_1/raw_data_1_pieces', 1786, 1820, 'output_video2.mp4', 'tracking_data2.csv')
    # ]
    caption = 'there is a ball'#语言文本

    directories = [
        ('F:/raw_data5/raw_data_0_pieces', 79, 81, 'output_video1.mp4', 'tracking_data1.csv'),
        ('F:/raw_data5/raw_data_1_pieces', 79, 81, 'output_video2.mp4', 'tracking_data2.csv')
    ]#原始数据
